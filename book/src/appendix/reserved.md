...
they appear in **head position** of a list. The check happens *before*
...
Names *not* on this list are ordinary bindings, even when they feel like syntax.
...
keywords. You *can* shadow them, though doing so will confuse readers.
...
*See also:* [The Evaluation Model](../language/evaluation.md) ·
